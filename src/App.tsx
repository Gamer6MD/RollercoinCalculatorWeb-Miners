...
function App() {
  return (
    <Routes>
      ...
      <Route path="/merge" element={<MergeRedirect to="/merge.en.html" />} />
      <Route path="/en/merge" element={<MergeRedirect to="/merge.en.html" />} />
      <Route path="/tr/merge" element={<MergeRedirect to="/merge.tr.html" />} />
      <Route path="*" element={<Navigate to="/" replace />} />
    </Routes>
  );
}

// Custom redirect component that uses window.location.href for proper redirect
function MergeRedirect({ to }: { to: string }) {
  useEffect(() => {
